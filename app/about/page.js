  ...
  return (
    <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
      ...
      <div className="col-span-2">
        <Image
          src={image1} // imported statically so it don't need (width + height) or (fill)
          placeholder="blur"
          quality={80}
...
// 1) image needs to be inside some container
// 2) specify size of that container
// 3) make the image fit that container with (object fit set to cover)

// statically imported => (no dimensions at all is optional as next js will figure out dimensions)
// src imported => should have dimensions (width+height or fill)
// placeholder only with statically imported lol
